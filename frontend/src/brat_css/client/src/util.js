...
var Util = (function(window, undefined) {
    ...
    var fontLoadTimeout = 10000; // 5 seconds
...
//             return color;
    ...
    var loadFonts = function(webFontURLs, dispatcher) {
      ...
      webFontURLs = webFontURLs || [
        'http://localhost:8001/brat/static/fonts/Astloch-Bold.ttf',
        'http://localhost:8001/brat/static/fonts/PT_Sans-Caption-Web-Regular.ttf',
        'http://localhost:8001/brat/static/fonts/Liberation_Sans-Regular.ttf'
      ];
